...
{
	game->FullScreen();
	startButton.SetPosition(vec2(wind->GetWidth() / 2.0f, (wind->GetHeight() / 2.0f) - 60.0f));
	quitButton.SetPosition(vec2(wind->GetWidth() / 2.0f, (wind->GetHeight() / 2.0f) + 60.0f));
	resumeButton.SetPosition(vec2(wind->GetWidth() / 2.0f, (wind->GetHeight() / 2.0f) - 60.0f));
	menuButton.SetPosition(vec2(wind->GetWidth() / 2.0f, (wind->GetHeight() / 2.0f) + 60.0f));
